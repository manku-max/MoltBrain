...
description: "Use claude-recall in Cursor with Google's free Gemini API"
---

# Cursor + Gemini Setup

This guide walks you through setting up claude-recall in Cursor using Google's Gemini API. Gemini offers a generous free tier that handles typical individual usage.
...
## Step 2: Clone and Build claude-recall
...
{
  "CLAUDE_RECALL_PROVIDER": "gemini",
  "CLAUDE_RECALL_GEMINI_API_KEY": "your-key",
  "CLAUDE_RECALL_GEMINI_MODEL": "gemini-2.5-flash"
}
```

## Rate Limiting

claude-recall automatically handles rate limiting for free tier usage:
...
{
  "CLAUDE_RECALL_PROVIDER": "gemini",
  "CLAUDE_RECALL_GEMINI_API_KEY": "AIza..."
}
```
