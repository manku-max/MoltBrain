...
description: "Use claude-recall in Cursor with OpenRouter's 100+ AI models"
---

# Cursor + OpenRouter Setup

This guide walks you through setting up claude-recall in Cursor using OpenRouter. OpenRouter provides access to 100+ AI models from various providers, including several free options.
...
{
  "CLAUDE_RECALL_PROVIDER": "openrouter",
  "CLAUDE_RECALL_OPENROUTER_API_KEY": "your-key",
  "CLAUDE_RECALL_OPENROUTER_MODEL": "google/gemini-2.0-flash-exp:free"
}
```
...
{
  "CLAUDE_RECALL_PROVIDER": "openrouter",
  "CLAUDE_RECALL_OPENROUTER_API_KEY": "sk-or-..."
}
```
