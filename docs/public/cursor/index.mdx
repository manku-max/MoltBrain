...
Every Cursor session starts fresh - your AI doesn't remember what it worked on yesterday. claude-recall changes that. Your agent builds cumulative knowledge about your codebase, decisions, and patterns over time.
...
claude-recall integrates with Cursor through native hooks:
...
After installation, these commands are available from the claude-recall directory:
...
3. Verify lifecycle.json exists in `.cursor/` directory
