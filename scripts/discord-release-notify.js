...
async function postToDiscord(webhookUrl, version, notes) {
  ...
  const repoUrl = 'https://github.com/nhevers/claude-recall';

  const payload = {
    embeds: [
      {
        title: `🚀 claude-recall ${version} released`,
        ...
        fields: [
          ...
          {
            name: '📚 Docs',
            value: '[docs.claude-recall.ai](https://docs.claude-recall.ai)',
            inline: true,
          },
        ],
        footer: {
          text: 'claude-recall • Persistent memory for Claude Code',
        },
